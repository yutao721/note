...
![generatororiginal](https://img.zhufengpeixun.com/generatororiginal.png)

![generatorexecflow](https://img.zhufengpeixun.com/generatorexecflow.png)
...
![redux-saga-flow2.jpg](https://img.zhufengpeixun.com/redux-saga-flow2.jpg)
...
export function\* rootSaga() { yield takeEvery(actionTypes.ASYNC\_ADD,add); }
