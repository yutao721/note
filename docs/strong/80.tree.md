...
src\_\_tests\_\_\\utils.spec.tsx
...
test\_\_mocks\_\_\\file-mock.js
...
test\_\_mocks\_\_\\object-mock.js
...
![treecomponent](http://img.zhufengpeixun.cn/treecomponent.png)
...
ReactDOM.render(<tree>, document.getElementById('root'));</tree>
```
...
export interface TreeData {
    ...
    type: string;
    collapsed?: boolean;
    children?: Array<treedata>; parent?: TreeData; }</treedata>
```
...
class Tree extends React.Component<props>{ render() { return (
Tree
